      ...
      <form className="text-white flex justify-center " onSubmit={handleSumit}>
        ...
        <div className="relative">
          ...
          <input
            ...
            name="activities"
            id="default-search"
            className="block ring-2 appearance-none ring-black  p-4 pl-10 w-96 text-sm placeholder-white text-white bg-[#2C7CD1] rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "
