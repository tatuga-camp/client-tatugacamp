    ...
    <div className='max-w-[1240px] mx-auto py-10 grid lg:grid-cols-2 '>
      ...
      <div className={`${isOdd ? 'lg:order-2' : ''}`}>
          ...
          <div className='px-10 flex flex-col'>
            <span className="text-4xl md:text-5xl  font-semibold text-[#2C7CD1] leading-tight">{title}</span>    
            <span className='text-2xl lg:text-4xl font-Kanit font-semibold'>{subTitle}</span>
            <p className='font-Kanit text-sm md:text-base mt-3 md:mt-8'>{info}</p>
          </div>      
      ...
      {/* Image */}
      <div className={`my-6 flex justify-center items-center ${isOdd ? 'lg:order-1' : ''} `}>
        <MockImg/>
      </div>
