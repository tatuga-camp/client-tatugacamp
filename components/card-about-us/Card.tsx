...
import Empertise from "../svgs/social_logo/empertise";
...
function Card({ title, subTitle, info, button, index, image }: CardProps) {
  const isOdd = index % 2 !== 0;

  //prevent draging image
  const handlePreventDragHandler = (e: React.FormEvent) => {
    e.preventDefault();
  };
  return (
    <section className="max-w-[1240px] mx-auto py-10 grid lg:grid-cols-2 ">
      ...
      <div className="flex justify-center items-center">
        <div
          className="mt-5 w-[20rem] h-[15rem] md:mt-10 md:w-[35rem]  md:h-[25rem] lg:w-[30rem] lg:h-[25rem] bg-transparent  relative overflow-hidden 
