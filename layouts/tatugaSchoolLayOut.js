...
function Layout({
  ...
  return (
    ...
    hover:scale-125 transition duration-100 ease-in-out "
      ...
      >
        <div className="w-11/12 h-28 grid grid-cols-6 1 gap-5 ">
          <button
            onClick={() => {
              router.push({
                pathname: "/school",
          ...
          <button
            ...
            } duration-150 hover:bg-blue-400 group drop-shadow-lg
          ...
          <button
            ...
            transition duration-150 hover:bg-green-400 group drop-shadow-lg rounded-lg
           flex justify-center gap-10 items-center relative`}
          >
            <div
              className={`flex justify-center items-center text-3xl 
