...
import {
  GetAboutUsInformationSanityService,
  GetMembersSanityService,
} from "../../sanity/services";
import { AboutUsInformation, Member } from "../../sanity/sanity-models";
    ...
    <HomepageLayout>
      ...
      <div className="flex flex-col items-center justify-center z-10 relative">
        <Head>
          ...
          <meta
            name="description"
            content="จัดการชั้นเรียนและบริหารห้องเรียนอย่างมีประสิทธิภาพ ด้วยเว็บไซต์จัดการชั้นเรียนTatuga Class - มากประสบการณ์ด้วยการจัดค่ายภาษาอังกฤษมากกว่า 30 โรงเรียน ผ่านเกมและกิจกรรม นวัตกรรมที่ทันสมัย"
          />
          ...
          <meta
            property="og:title"
            content="tatugacamp About us - เกี่ยวกับเรา"
          />
          <meta
...
export const getStaticProps: GetStaticProps = async (ctx) => {
  const [members, information] = await Promise.all([
    GetMembersSanityService(),
    GetAboutUsInformationSanityService(),
  ]);
  return {
