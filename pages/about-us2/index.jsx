...
const index = () => {
  ...
  const profile = [
    {
      ...
      quote:
        'Creating a positive environment is the must when starting to teach.',
    },
    {
    ...
    },
    {
      ...
      quote:
        'Learning is an ongoing journey that extends beyond the classroom.',
    },
    {
      profileName: 'Thanathip Buates',
      role: 'Co-founder & Marketing manager',
      quote:
        'Education is the bridge that connects us to a deeper understanding of the world and each other.',
    },
    {
      profileName: 'Airiya Chinakan',
      role: 'Co-founder & Human resource manager',
      quote:
        "Don't hesitate to admit when you have no idea, as it's the starting point for everyone's learning.",
    },
    {
      profileName: 'Chanidapa Praneetpolklang',
      role: 'Product designer',
      quote:
        'Learning is a lifelong journey. Embrace curiosity and never stop seeking knowledge.',
    },
    {
      profileName: 'Pawarit Tengwattana',
      role: 'Marketing',
      quote:
        "There's always earning in learning. When we learn something, we earn something.",
    },
    {
  ...
  return (
    <Layout>
      {/* Banner */}
      <div className="w-full h-[300px] bg-slate-200 mt-0">Mockup Banner</div>
            ...
            <section className="flex flex-col relative  md:w-[600px] lg:w-[800px] xl:w-max px-10 md:px-20 ">
              ...
              <div className="grid grid-cols-2 mt-4 md:mt-5">
                ...
                <ul className="flex flex-col ">
                  <li className="text-[3vw] md:text-[2.5vw] lg:text-[1.5vw] mb-2 md:mb-4 flex items-center gap-1 md:gap-3 font-medium">
                    <Facebook />
                    {contacts.name}
                  </li>
                  <li className="text-[3vw] md:text-[2.5vw] lg:text-[1.5vw] mb-2 md:mb-4 flex items-center gap-1 md:gap-3 font-medium">
